...
const apiKey = '6355a7fc9a5032f5a3c1df7e6044dea2'; // Substitua por sua API Key do ScraperAPI
...
app.get('/buscar', async (req, res) => {
    ...
    try {
        // URL da busca usando ScraperAPI como proxy
        ...
        const cidade = empresaDiv.find('p').eq(3).text().trim(); // Ajustado conforme a estrutura
